<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      >
        <img v-if="settingsLoaded" :src="siteLogo || '/logo.svg?v=2'" alt="Logo" class="h-full w-full object-contain" />
      </router-link>
...
const userNavItems = computed((): NavItem[] => {
  const items: NavItem[] = [
    { path: '/console-home', label: t('nav.consoleHome'), icon: HomeIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/channels/pricing', label: t('nav.channelManagement'), icon: ChannelIcon, hideInSimpleMode: true },
    ...
    { path: '/admin/chat', label: t('nav.chat'), icon: BellIcon },
