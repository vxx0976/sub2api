        ...
        <Transition name="scale">
          ...
          >
            ...
            <div class="p-6 text-center">
              <!-- Header -->
              <div class="mb-4">
                <div class="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-green-400 to-green-600 shadow-lg shadow-green-500/30">
