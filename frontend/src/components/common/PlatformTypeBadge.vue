...
const platformClass = computed(() => {
  switch (props.platform) {
    ...
    case 'glm': return 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400'
...
const typeClass = computed(() => {
  switch (props.platform) {
    ...
    case 'glm': return 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400'
