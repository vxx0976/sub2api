  ...
  >
    ...
    >
      ...
      >
        <div class="mb-3 flex items-center justify-between">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.status.accountSchedulingThresholdOverride') }}</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.status.accountSchedulingThresholdOverrideHint') }}
            </p>
          </div>
          <input
        ...
        <div v-if="accountSchedulingThresholdOverrideEnabled">
          <label class="input-label">{{ t('admin.accounts.status.accountSchedulingThresholdOverrideValue') }}</label>
          <input
            ...
            class="input"
          />
          <p class="input-hint">{{ t('admin.accounts.status.accountSchedulingThresholdOverrideDisabledHint') }}</p>
        </div>
      </div>
