...
const openaiPresetMappings = [
  ...
  { label: 'Haiku→5.6 Sol', from: 'claude-haiku-4-5-20251001', to: 'gpt-5.6-sol', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
  { label: 'Opus→6 Astra', from: 'claude-opus-4-6', to: 'gpt-6-astra', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
  { label: 'Sonnet→5.6 Sol', from: 'claude-sonnet-4-6', to: 'gpt-5.6-sol', color: 'bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-400' }
]
