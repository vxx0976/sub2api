<template>
  <AppLayout>
            ...
            <div v-if="visibleFilters.has('role')" class="w-full sm:w-32">
              <Select
                ...
                :options="[
                  ...
                  { value: 'reseller', label: t('admin.users.reseller') },
    ...
    <GroupReplaceModal :show="showGroupReplaceModal" :user="groupReplaceUser" :old-group="groupReplaceOldGroup" :all-groups="allGroups as AdminGroup[]" @close="closeGroupReplaceModal" @success="loadUsers" />
...
import type { User, AdminUser, AdminGroup, Group, UserAttributeDefinition } from '@/types'
...
const platformQuotaUser = ref<User | null>(null)

const handlePlatformQuota = (user: User) => {
