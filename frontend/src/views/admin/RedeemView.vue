      ...
      <template #table v-if="activeTab === 'redeem'">
        <DataTable :columns="columns" :data="codes" :loading="loading">
          ...
          <template #cell-type="{ value }">
            <span :class="['badge', value === 'balance' ? 'badge-success' : value === 'subscription' ? 'badge-warning' : 'badge-primary']">
          ...
          <template #cell-value="{ value, row }">
            <span class="text-sm font-medium text-gray-900 dark:text-white">
              ...
              <template v-else-if="row.type === 'subscription'">
                ...
                <span v-if="row.group" class="ml-1 text-xs text-gray-500 dark:text-gray-400">({{ row.group.name }})</span>
              </template>
          ...
          <template #cell-status="{ value }">
            <span :class="['badge', value === 'unused' ? 'badge-success' : value === 'used' ? 'badge-gray' : 'badge-danger']">
