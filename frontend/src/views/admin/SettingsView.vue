  ...
  <AppLayout>
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <!-- 人机验证 Settings（Turnstile / 腾讯天御 / 阿里云验证码 2.0） -->
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
          ...
          <div class="space-y-5 p-6">
            ...
            >
              ...
              <div class="mb-6">
                ...
                <div class="grid grid-cols-3 gap-2 rounded-lg bg-gray-100 p-1 dark:bg-dark-700">
                  <button
                    type="button"
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            >
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        class="input font-mono text-sm"
                        :placeholder="localText('微信开放平台 PC 应用 AppID', 'WeChat Open Platform PC App ID')"
                      />
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      ...
                      <input
                        ...
                        :placeholder="
                          form.wechat_connect_open_app_secret_configured
                            ? localText('密钥已配置，留空以保留当前值。', 'Secret configured. Leave empty to keep the current value.')
                            : localText('微信开放平台 PC 应用 AppSecret', 'WeChat Open Platform PC App Secret')
                        "
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        class="input font-mono text-sm"
                        :placeholder="localText('公众号 AppID', 'Official Account App ID')"
                      />
                    </div>
                    <div>
                      <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
              ...
              <div
                v-if="form.wechat_connect_open_enabled && (form.wechat_connect_mp_enabled || form.wechat_connect_mobile_enabled)"
          ...
          <div class="space-y-5 p-6">
            ...
            >
              <div class="min-w-0">
                <label
                  class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  for="openai-oauth-scheduling-rate-multiplier-weighted"
                >
                  {{ t('admin.settings.openaiExperimentalScheduler.oauthRateTitle') }}
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
              ...
              <div class="relative w-full shrink-0 sm:w-32">
                <input
                  id="openai-oauth-scheduling-rate-multiplier-weighted"
                  v-model.number="form.openai_oauth_scheduling_rate_multiplier"
                  class="input pr-8"
                  data-testid="openai-oauth-scheduling-rate-multiplier"
                  min="0"
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            <!-- Grok default text model / cross-client model map -->
            <div
            ...
            <div>
              ...
              <input
                ...
                class="input w-full font-mono text-sm"
                :placeholder="
                  t('admin.settings.gatewayForwarding.openaiCodexClientVersionPlaceholder')
                "
              />
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
        ...
        <!-- Model Plaza (/model-plaza) feature card -->
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
              {{ t('admin.settings.features.translation.title') }}
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('admin.settings.features.translation.description') }}
            </p>
          </div>
          <div class="space-y-4 p-6">
            <div>
              <label class="input-label">{{ t('admin.settings.features.translation.baseUrl') }}</label>
              <input
                v-model="translationForm.base_url"
                type="text"
                class="input"
                placeholder="https://api.openai.com"
              />
              <p class="input-hint">{{ t('admin.settings.features.translation.baseUrlHint') }}</p>
            </div>
            <div>
              <label class="input-label">{{ t('admin.settings.features.translation.model') }}</label>
              <input
                v-model="translationForm.model"
                type="text"
                class="input"
                placeholder="gpt-4o-mini"
              />
              <p class="input-hint">{{ t('admin.settings.features.translation.modelHint') }}</p>
            </div>
            <div>
              <label class="input-label">{{ t('admin.settings.features.translation.apiKey') }}</label>
              <input
                v-model="translationForm.api_key"
                type="password"
                class="input"
                autocomplete="new-password"
                :placeholder="translationConfigLoaded?.api_key_configured
                  ? translationConfigLoaded.api_key_masked
                  : 'sk-...'"
              />
              <p class="input-hint">
                {{ translationConfigLoaded?.api_key_configured
                  ? t('admin.settings.features.translation.apiKeyConfiguredHint')
                  : t('admin.settings.features.translation.apiKeyHint') }}
              </p>
            </div>
            <div>
              <label class="input-label">{{ t('admin.settings.features.translation.timeout') }}</label>
              <input
                v-model.number="translationForm.timeout_ms"
                type="number"
                min="1000"
                step="1000"
                class="input w-40"
              />
              <p class="input-hint">{{ t('admin.settings.features.translation.timeoutHint') }}</p>
            </div>
            <div class="flex flex-wrap items-center gap-2 pt-2">
              ...
              >
                {{ translationSaving
                  ? t('common.saving')
                  : t('admin.settings.features.translation.save') }}
              </button>
              <button
                v-if="translationConfigLoaded?.api_key_configured"
                type="button"
                class="btn-secondary"
                :disabled="translationSaving"
                @click="clearTranslationApiKey"
              >
                {{ t('admin.settings.features.translation.clearApiKey') }}
              </button>
            </div>
          </div>
        </div>
        ...
        <!-- 余额充值 / 支付宝个人免签 / USDT 三块配置已迁移到「支付设置」标签页（activeTab === 'payment'） -->
        ...
        <!-- Tab: 支付设置 — 自建收款通道 (余额充值 / 支付宝个人免签 / USDT)，与下方网关/订阅设置同属「支付设置」标签 -->
                  ...
                  >
                    <div class="mb-3 flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        :disabled="form.login_agreement_enabled && form.login_agreement_documents.length <= 1"
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              ...
              <a :href="paymentGuideHref" target="_blank" rel="noopener noreferrer" class="ml-2 inline-flex items-center text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
            ...
            <template v-if="form.payment_enabled">
              ...
              <div class="grid grid-cols-2 gap-3 sm:grid-cols-5">
                ...
                <div>
                  ...
                  <input :value="form.payment_subscription_usd_to_cny_rate || ''" @input="form.payment_subscription_usd_to_cny_rate = parseFloat(($event.target as HTMLInputElement).value) || 0" type="number" step="0.01" min="0" class="input" :placeholder="t('admin.settings.payment.subscriptionUsdToCnyRateDisabled')" />
              ...
              <div>
                ...
                <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                  ...
                  <a :href="paymentMethodsHref" target="_blank" rel="noopener noreferrer" class="ml-1 text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300">
...
import type { AdminGroup, LoginAgreementDocument, NotifyEmailEntry, Proxy } from '@/types'
...
// === Email OAuth (GitHub / Google) helpers ===
...
async function setAndCopyEmailOAuthRedirectUrl(provider: EmailOAuthProvider) {
  ...
  await copyToClipboard(url, localText('回调地址已写入并复制。', 'Callback URL set and copied.'))
}

// === Login Agreement helpers ===
...
function loginAgreementRoutePath(doc: LoginAgreementDocument, index: number): string {
  const id = normalizeLoginAgreementDocumentId(doc.id || doc.title) || `doc-${index + 1}`
  return `/legal/${id}`
}
...
type SettingsTab = 'general' | 'agreement' | 'features' | 'security' | 'users' | 'gateway' | 'payment' | 'email' | 'backup'
...
function handleSettingsTabKeydown(event: KeyboardEvent, tab: SettingsTab): void {
  const action =
    settingsTabKeyboardActions[event.key as keyof typeof settingsTabKeyboardActions]
  if (action === undefined) {
    return
  }
  ...
  if (action === 'first') {
    ...
    nextIndex = (nextIndex + action + settingsTabs.length) % settingsTabs.length
  }
...
// ===== Claude OAuth System Prompt 注入：系统提示块编辑器（从 main 移植） =====
...
// ===== end Claude OAuth System Prompt 注入 =====
...
async function loadSettings() {
  ...
  try {
    ...
    // 人机验证：按后端下发的三个 enabled 键回填单选态
    syncCaptchaProviderSelection()
    // Claude OAuth 系统提示块：把后端下发的 JSON 字符串解析成本地编辑数组
    if (!form.claude_oauth_system_prompt_blocks?.trim()) {
      form.claude_oauth_system_prompt_blocks = defaultClaudeOAuthSystemPromptBlocks
    }
    ...
    codexFingerprintRows.value = form.codex_cli_only_engine_fingerprint_signals
      ...
      : defaultFingerprintSignalRows()
    form.channel_monitor_mode = settings.channel_monitor_mode === 'v2' ? 'v2' : 'v1'
    form.channel_monitor_hide_throughput = Boolean(settings.channel_monitor_hide_throughput)
...
async function loadSubscriptionGroups() {
  try {
    const groups = await adminAPI.groups.getAll() as AdminGroup[]
...
function findNextAvailableSubscriptionGroup(existingGroupIDs: number[]): AdminGroup | undefined {
...
async function saveSettings() {
  ...
  try {
    ...
    // Claude OAuth 系统提示块：编辑数组序列化回 JSON 字符串再下发
    ...
    form.wechat_connect_mobile_enabled = updatedWechatCapabilities.mobileEnabled
    form.wechat_connect_mode = deriveWeChatConnectStoredMode(
    ...
    if (
      ...
      openaiFastPolicyForm.rules = updated.openai_fast_policy_settings.rules.map((rule) => ({
        ...rule,
        user_ids: rule.user_ids ? [...rule.user_ids] : [],
...
const translationConfigLoaded = ref<translationAPI.TranslationConfigView | null>(null)
...
async function loadTranslationConfig() {
  try {
    const cfg = await translationAPI.getConfig()
    translationConfigLoaded.value = cfg
    translationForm.base_url = cfg.base_url
    translationForm.model = cfg.model
    translationForm.timeout_ms = cfg.timeout_ms || 30000
...
async function saveTranslationConfig() {
  ...
  try {
    const payload: translationAPI.UpdateTranslationConfigRequest = {
      base_url: translationForm.base_url,
      model: translationForm.model,
      timeout_ms: translationForm.timeout_ms,
    }
    if (translationForm.api_key) {
      payload.api_key = translationForm.api_key
    }
    const cfg = await translationAPI.updateConfig(payload)
    translationConfigLoaded.value = cfg
    translationForm.api_key = ''
    appStore.showSuccess(t('admin.settings.features.translation.saved'))
  } catch (err) {
    appStore.showError(extractApiErrorMessage(err, t('common.error')))
  } finally {
...
async function clearTranslationApiKey() {
  translationSaving.value = true
  try {
    const cfg = await translationAPI.updateConfig({ clear_api_key: true })
    translationConfigLoaded.value = cfg
    translationForm.api_key = ''
    appStore.showSuccess(t('admin.settings.features.translation.apiKeyCleared'))
  } catch (err) {
    appStore.showError(extractApiErrorMessage(err, t('common.error')))
  } finally {
    translationSaving.value = false
