<template>
  <AppLayout>
    <div class="space-y-6">
      <UsageStatsCards :stats="usageStats" :show-account-cost="false" :strike-standard-cost="true" :show-standard-cost="!isRegularUser" />
...
// 仅管理员/分销商可见标准(折前)价；普通用户隐藏(fork 既有策略，勿在合并中丢失)
