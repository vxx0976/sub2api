            ...
            <div v-if="availableMethods.length > 1" class="mb-5">
              ...
              <div class="mt-2 grid gap-3" :class="availableMethods.length === 3 ? 'grid-cols-3' : 'grid-cols-2'">
                <button
                  ...
                  type="button"
                  :class="[
                    'flex flex-col items-center justify-center gap-1.5 rounded-xl border-2 px-3 py-3 text-sm font-medium transition-all',
                    activeMethod === m
...
const USDT_ICON =
  '<svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2 1.5 8v8L12 22l10.5-6V8L12 2Zm1.5 9.6v1.2c2.4.1 4.2.5 4.2 1s-1.8.9-4.2 1v3h-3v-3c-2.4-.1-4.2-.5-4.2-1s1.8-.9 4.2-1v-1.2c-2 .1-3.6.4-3.6.8v-2.4h6.6v2.4c0-.4-1.6-.7-3.6-.8h3.6Zm-1.5 2.1c2.9 0 5.4-.4 5.4-1s-2.5-1-5.4-1-5.4.4-5.4 1 2.5 1 5.4 1Z"/></svg>'
