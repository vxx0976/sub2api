    ...
    <div class="mx-auto max-w-4xl">
      ...
      <div class="mb-8">
        <div class="mb-2 flex items-center gap-3">
          <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-gray-700 to-gray-900 text-white dark:from-gray-600 dark:to-gray-800">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
          </div>
          <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ t('docs.cli.title') }}</h1>
        </div>
        <p class="text-gray-600 dark:text-gray-400">{{ t('docs.cli.subtitle') }}</p>
        <p class="mt-2 text-sm text-gray-400 dark:text-gray-500">{{ t('docs.cli.note') }}</p>
      </div>

      <!-- Prerequisites -->
      <section class="mb-8 rounded-xl border border-amber-200 bg-amber-50 p-6 dark:border-amber-800 dark:bg-amber-900/20">
...
<span class="text-green-400">echo</span> <span class="text-white">%ANTHROPIC_AUTH_TOKEN%</span></code></pre>
      ...
      <!-- Tips Box -->
      <section class="mb-8 rounded-xl border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/20">
