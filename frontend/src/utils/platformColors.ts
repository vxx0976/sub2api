...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'deepseek' | 'moonshot' | 'glm' | 'qwen' | 'seedance' | 'grok' | 'composite'
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  moonshot: 'border-indigo-500/35 dark:border-indigo-500/30',
  glm: 'border-rose-500/35 dark:border-rose-500/30',
  qwen: 'border-violet-500/35 dark:border-violet-500/30',
  seedance: 'border-amber-500/35 dark:border-amber-500/30',
...
const ACCENT: Record<Platform, string> = {
  ...
  moonshot: '#6366f1', // indigo-500
  glm: '#f43f5e', // rose-500
  qwen: '#8b5cf6', // violet-500
  seedance: '#f59e0b', // amber-500
