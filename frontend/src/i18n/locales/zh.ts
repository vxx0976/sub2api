export default {
  ...
  recharge: {
    ...
    creditPreview: '预计到账',
    multiplierApplied: '已享 x{multiplier} 倍率',
    payTypeLabel: '支付方式',
    payType_alipay: '支付宝',
    payType_wxpay: '微信支付',
    submitButton: '立即充值',
  ...
  admin: {
    ...
    settings: {
      ...
      recharge: {
        ...
        tiers: '充值倍率档位',
        tiersPlaceholder: '见下方格式说明',
        tiersHint: 'JSON 数组，每项含 min（下限）、max（上限，null 表示无上限）、multiplier（倍率）。留空表示不设置倍率。',
        epayTitle: '支付网关配置',
        epayApiUrl: 'API 地址',
        epayPid: '商户 ID (PID)',
        epayKey: '商户密钥',
