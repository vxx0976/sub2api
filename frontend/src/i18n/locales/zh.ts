export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      timeTierNoteWeekdays: '官方分时段计价：仅工作日（周一至周五）{windows}（{tz}）为高峰，其余时段与周末全天按 {percent}% 计价'
    },
    nav: {
      login: '登录',
  ...
  admin: {
    ...
    users: {
      ...
      disableKey: '停用',
      enableKey: '启用',
      keyDisabledSuccess: '该密钥已停用，立即生效',
      keyEnabledSuccess: '该密钥已启用',
      keyStatusChangeFailed: '修改密钥状态失败',
      group: '分组',
      none: '无',
    ...
    settings: {
      ...
      tencentCaptcha: {
        ...
        regionCn: '中国大陆',
        regionIntl: '国际站',
        regionHint: '决定加载的 SDK 脚本与服务端校验接口地址，必须与签发 CaptchaAppId 的站点一致；国际站应用在 tencentcloud.com 控制台创建。',
