export default {
  ...
  auth: {
    ...
    checkSpamFolder: '如未收到邮件，请检查垃圾邮件文件夹。',
  ...
  topupOrders: {
    ...
    refund: '退款',
    refundTitle: '确认退款',
    refundConfirm: '确认为订单 {orderNo} 退款 ${amount}？将扣回到账余额。',
  ...
  recharge: {
    ...
    methodWechat: '微信',
    methodUsdt: 'USDT',
    viewAllOrders: '查看充值记录',
    title: '余额充值',
    description: '通过在线支付充值账户余额',
    currentBalance: '当前余额',
    disabled: '充值功能未开启',
    disabledDesc: '充值功能暂时未开启，请联系管理员。',
    loadConfigFailed: '加载充值配置失败',
    formTitle: '充值',
    priceInfo: '当前汇率：¥{price}/USD',
    amountLabel: '充值金额 (CNY)',
    amountPlaceholder: '请输入金额（{min} - {max}）',
    amountHint: '充值金额范围：¥{min} - ¥{max}',
    creditPreview: '预计到账',
    payTypeLabel: '支付方式',
    payType_alipay: '支付宝',
    payType_wxpay: '微信支付',
    submitButton: '立即充值',
    submitting: '创建订单中...',
    orderCreated: '订单已创建，请扫码完成支付',
    createOrderFailed: '创建订单失败',
    paymentSuccess: '支付成功，余额已到账！',
    checkingPayment: '正在检查支付结果...',
    scanToPay: '扫码支付',
    payAmount: '支付金额',
    scanQRHintWechat: '请使用微信扫一扫完成支付',
    scanQRHintAlipay: '请使用支付宝扫一扫完成支付',
    openPayPage: '无法扫码？点击打开支付页面',
  ...
  usdt: {
    title: 'USDT 充值',
    description: 'USDT(TRC20) 链上充值',
    formTitle: 'USDT 充值',
    estimatedPay: '预计支付',
    rateHint: '参考汇率 1 USDT ≈ ¥{rate}（最终以下单时锁定金额为准）',
    selectChain: '选择网络',
    amountLabel: '充值数量 (USDT)',
    amountPlaceholder: '输入 USDT 数量',
    amountHint: '充值范围 {min} - {max} USDT',
    amountHintNoMax: '最低 {min} USDT 起，无上限',
    scanToPay: '扫码支付 USDT',
    networkWarning: '仅支持 {chain} 网络，请勿使用其他网络转账，否则资金无法找回',
    payExactAmountNotice: '请按以下精确金额转账',
    amountMustMatch: '金额必须完全一致（精确到小数点后 6 位），否则系统无法自动到账',
    copy: '复制',
    copied: '已复制',
    copyFailed: '复制失败',
  ...
  admin: {
    ...
    dashboard: {
      ...
      cache: '缓存',
      recentUsage: '最近使用',
      financeTrendTitle: '充值与消耗趋势（USD）',
      platformBalance: '平台总余额',
      platformBalanceHint: '所有用户当前余额之和',
      channelBalance: '所有渠道总余额',
      channelBalanceHint: '所有渠道缓存余额之和',
      todayRecharge: '今日充值',
      ...
      margin: '毛利',
      rangeMargin: '区间毛利',
      rechargeSourceTitle: '充值来源占比（USD）',
      rangeTotal: '区间合计',
      srcAlipay: '支付宝',
      srcWxpay: '微信支付',
      srcRedeem: '兑换码',
      srcAdminManual: '管理员手工',
    ...
    groups: {
      ...
      form: {
        ...
        translateAll: '一键翻译',
        translating: '翻译中…',
        translateAllHint: '调用 LLM 把当前名称和描述翻译成所有支持语言（会覆盖现有翻译）',
        translateNoSource: '请先填写名称或描述',
        translateSuccess: '翻译完成',
        translateEmpty: '翻译已返回，但目标语言字段为空，请检查模型输出',
        platform: '平台',
        rateMultiplier: '费率倍数',
        status: '状态',
        exclusive: '专属分组',
      ...
      smartRouter: {
        enable: '启用智能路由（虚拟故障转移分组）',
        enableHint: '开启后此分组将作为虚拟路由，按顺序把请求转发到成员分组，成员不可用时自动切换',
        enabledBadge: '智能路由已启用',
        editHint: '智能路由分组只能修改名称、描述、状态和成员列表；费率、限额、模型路由等字段由各成员自己管理',
        members: '成员分组（按顺序）',
        membersHint: '按顺序排列；当前优先级：第一个正常的成员会成为 active',
        addMember: '添加成员...',
        openDetail: '打开详情页 →',
        detailTitle: '智能路由详情',
        detailDescription: '查看成员健康、用量、事件时间线，管理手动锁定',
        active: 'Active',
        schedulable: '可调度',
        healthy: '健康',
        probe: '立即探测',
        ...
        eventReason: {
          ...
          bootstrap: '初始化',
          no_members_available: '无可用成员'
        },
        pinDialog: {
          title: '锁定到成员',
          description: '锁定期间自动路由将被短路，流量固定走：',
          confirm: '确认锁定',
          ttl: '锁定时长',
          ttl30m: '30 分钟',
          ttl2h: '2 小时',
    ...
    channels: {
      ...
      createChannel: '创建渠道',
      refreshBalance: '刷新余额',
      refreshAllBalances: '刷新所有渠道余额',
      refreshBalanceFailed: '刷新余额失败',
      noBalanceUrls: '没有配置余额查询地址的渠道',
      editChannel: '编辑渠道',
      deleteChannel: '删除渠道',
      statusActive: '启用',
      statusDisabled: '停用',
    ...
    accounts: {
      ...
      quotaLimitHint: '设置 5h/日/周/总使用额度（美元），任一维度达到限额后账号暂停调度。Anthropic API Key 账号还可配置客户端亲和。修改限额不会重置已用额度。',
      quotaLimitToggle: '启用配额限制',
      quotaLimitToggleHint: '开启后，当账号用量达到设定额度时自动暂停调度',
      quota5hLimit: '5 小时限额',
      quota5hLimitHint: '滚动 5 小时窗口，从首次使用起每 5 小时自动重置。',
      quotaDailyLimit: '日限额',
      ...
      dataExportConfirmMessage: '确认导出账号数据？',
      dataExportConfirm: '导出',
      dataExportIncludeProxies: '包含代理配置',
      dataExported: '数据导出成功',
      dataExportFailed: '数据导出失败',
      dataImportTitle: '导入账号数据',
      dataImportHint: '支持导入 JSON 格式的账号数据文件',
      dataImportWarning: '导入将覆盖同名账号，请谨慎操作',
      dataImportFile: '选择文件',
      dataImportSelectFile: '请选择要导入的文件',
      dataImportResult: '导入结果',
      dataImportResultSummary: '成功 {success} 个，失败 {failed} 个，跳过 {skipped} 个',
      dataImportErrors: '错误详情',
      dataImporting: '导入中...',
    ...
    proxies: {
      ...
      dataExport: '导出数据',
      dataExportSelected: '导出选中',
      dataExportConfirmMessage: '确认导出代理数据？',
      dataExportConfirm: '导出',
      dataExported: '数据导出成功',
      dataExportFailed: '数据导出失败',
      dataImportTitle: '导入代理数据',
      dataImportHint: '支持导入 JSON 格式的代理数据文件',
      dataImportWarning: '导入将覆盖同名代理，请谨慎操作',
      dataImportFile: '选择文件',
      dataImportSelectFile: '请选择要导入的文件',
      dataImportResult: '导入结果',
      dataImportResultSummary: '成功 {success} 个，失败 {failed} 个，跳过 {skipped} 个',
    ...
    settings: {
      ...
      features: {
        ...
        translation: {
          title: '一键翻译（多语言字段）',
          description: '配置一个 OpenAI 兼容的大模型，用于在分组等多语言字段上调用「一键翻译」按钮自动填充其他语言。',
          baseUrl: 'Base URL',
          baseUrlHint: 'OpenAI 兼容的 chat/completions 端点根地址，无需带 /v1。',
          model: '模型',
          modelHint: '推荐使用便宜且支持 JSON 输出的模型，如 gpt-4o-mini。',
          apiKey: 'API Key',
          apiKeyHint: '仅服务端使用，不会回显。',
          apiKeyConfiguredHint: '已配置 API Key，留空则保持当前值。',
          timeout: '超时（毫秒）',
          timeoutHint: '单次翻译请求的超时时间。',
          save: '保存翻译配置',
          saved: '翻译配置已保存',
      ...
      site: {
        ...
        defaultLocaleHint: '未手动选择语言的用户将默认显示此语言，留空则跟随浏览器语言',
        apiBaseUrl: 'API 端点地址',
      ...
      recharge: {
        ...
        enabled: '启用充值功能',
        enabledHint: '开启后，侧边栏将显示充值入口，用户可自助充值余额',
        minAmount: '最小充值金额 (¥)',
        maxAmount: '最大充值金额 (¥)',
        payTypes: '支付方式',
        payTypesPlaceholder: '如：["alipay","wxpay"]',
        payTypesHint: 'JSON 数组格式，可选值：alipay（支付宝）、wxpay（微信支付）。留空默认两者都启用。',
        epayTitle: '支付网关配置',
        epayApiUrl: 'API 地址',
        epayPid: '商户 ID (PID)',
        epayKey: '商户密钥',
        epayKeyPlaceholder: '输入商户密钥（Key）',
        epayKeyHint: '密钥仅在填写时更新，留空则保留原值。',
        keyConfigured: '已配置',
      },
      alimpay: {
        title: '支付宝个人免签（AliMPay）',
        description: '通过支付宝账单轮询实现个人免签收款。修改后实时生效，无需重启服务。',
        enabled: '启用 AliMPay',
        enabledHint: '开启后前端显示支付宝扫码充值入口，后台 Monitor 协程开始匹配账单',
        mode: '收款模式',
        modeBusinessQR: '经营码（通过金额偏移匹配）',
        modeTransfer: '转账（通过备注订单号匹配）',
        modeHint: '经营码模式需要开通"收钱码"，转账模式需支付宝用户 ID',
        appId: '应用 ID (app_id)',
        appIdPlaceholder: '支付宝开放平台应用 ID',
        privateKey: '应用私钥 (RSA2)',
        privateKeyPlaceholder: '粘贴 PKCS1/PKCS8 格式的 RSA 私钥',
        alipayPublicKey: '支付宝公钥',
        alipayPublicKeyPlaceholder: '粘贴支付宝开放平台提供的支付宝公钥',
        keyConfigured: '已配置',
        keyKeepPlaceholder: '已配置（留空表示保留原值）',
        keyHint: '私钥仅存储在数据库 settings 表，后端访问 API 时签名使用',
        businessQRURL: '经营码 URL',
        businessQRURLHint: '完整的 https://qr.alipay.com/... 链接；用户扫此码支付',
        amountOffset: '金额偏移步长 (¥)',
        amountOffsetHint: '相同基础金额的订单通过偏移区分，默认 0.01',
        transferUserId: '收款方支付宝 UID',
        transferUserIdHint: 'alipays 协议 biz_data 中的 u 字段值',
        advanced: '高级参数',
        serverURL: '支付宝网关地址',
        orderTimeoutSeconds: '订单超时（秒）',
        monitorIntervalSeconds: '轮询间隔（秒）',
        matchToleranceSeconds: '匹配时间容差（秒）',
        queryMinutesBack: '账单查询回溯（分钟）',
        saveButton: '保存 AliMPay 配置',
        saveSuccess: 'AliMPay 配置已保存并生效',
      },
      usdt: {
        title: 'USDT 自建收款（多链）',
        description: '通过轮询链上数据实现 USDT 收款，支持 TRC20 / BEP20 / TON。修改后实时生效，无需重启。',
        ...
        minAmount: '最小充值 (USDT)',
        maxAmount: '最大充值 (USDT)',
        maxAmountHint: '填 0 表示不限上限',
        receivingAddress: 'TRC20 收款地址',
        receivingAddressHint: 'T 开头的 TRON 地址，所有订单收款到此地址（请用观察钱包，勿在服务器存私钥）',
        tronApiKey: 'TronGrid API Key',
        tronApiKeyPlaceholder: '从 trongrid.io 申请的 API Key',
        tronApiKeyHint: '用于提高 TronGrid 调用配额，强烈建议配置',
        keyConfigured: '已配置',
        keyKeepPlaceholder: '已配置（留空表示保留原值）',
        rateSection: '汇率',
        rateAutoFetch: '自动获取汇率',
        rateAutoFetchHint: '开启后从 CoinGecko 拉取 USDT/CNY 市场价，失败回退手动汇率',
        manualRate: '手动汇率 (1 USDT = ? CNY)',
        manualRateHint: '未开启自动获取时使用；自动获取失败时作为兜底',
        rateMarkup: '加价系数 (0~1)',
        rateMarkupHint: '换算用汇率 = 汇率×(1-加价)，让用户多付一点 USDT；0 表示不加价',
        advanced: '高级参数',
        tronApiBaseUrl: 'TronGrid 网关地址',
        amountOffset: '唯一金额尾数步长 (USDT)',
        amountTolerance: '到账金额容差 (USDT)',
        amountToleranceHint: '实收与应付在 ±容差内即算成功(按下单金额入账)；尾数步长会自动 >2×容差防混单',
        confirmSeconds: '确认等待（秒）',
        orderTimeoutSeconds: '订单超时（秒）',
        monitorIntervalSeconds: '轮询间隔（秒）',
        queryMinutesBack: '链上回看窗口（分钟）',
        saveButton: '保存 USDT 配置',
        saveSuccess: 'USDT 配置已保存并生效',
      },
      customMenu: {
        title: '自定义菜单页面',
    ...
    usdtOrders: {
      title: 'USDT 订单',
      description: '查看与管理 USDT(TRC20) 充值订单',
      usdtAmount: 'USDT 金额',
      txHash: '交易哈希',
    },
