export default {
  ...
  pricing: {
    ...
    custom: {
      ...
      wechatTitle: 'WeChat hinzufuegen',
  ...
  plans: {
    ...
    enterprise: {
      ...
      contactMessage: 'Bitte kontaktieren Sie uns fuer einen individuellen Plan: WeChat mayione1',
      features: {
      ...
      dialog: {
        ...
        subtitle: 'WeChat mayione1 hinzufuegen fuer massgeschneiderte Loesungen',
  ...
  recharge: {
    ...
    platformBalance: 'Plattformguthaben',
    rateDescCny: '¥1 = ${multiplier} Plattformguthaben, Abrechnung nach tatsächlichem Verbrauch',
    rateDescUsd: '$1 = ¥{rate} × {multiplier} = ${total} Plattformguthaben',
    balanceNeverExpires: 'Guthaben läuft nie ab, zahlen Sie nur was Sie nutzen',
    amountRange: 'Bereich: {symbol}{min} - {symbol}{max}',
    invalidAmountRange: 'Betrag muss zwischen {symbol}{min} und {symbol}{max} liegen',
    cryptoPayment: 'Krypto-Zahlung',
    cryptoHint: 'Bitte kontaktieren Sie den Support nach der Überweisung zur Bestätigung',
    copySuccess: 'Adresse kopiert',
    currentBalance: 'Current Balance',
    bonus: 'Aufladebonus',
  ...
  reseller: {
    ...
    settings: {
      ...
      contactWechat: 'WeChat-ID',
      contactTelegram: 'Telegram',
      announcementsSection: 'Startseiten-Ankündigungen',
      announcementsHint: 'Kurze Ankündigungen, die oben auf der Startseite der Benutzerkonsole angezeigt werden',
      announcementTitle: 'Titel',
      announcementDate: 'Datum (optional)',
