export default {
  ...
  redeem: {
    ...
    balanceAddedRecharge: 'Balance Added (Recharge)',
  ...
  topupOrders: {
    ...
    refundConfirm: 'Refund ${amount} for order {orderNo}? The credited balance will be deducted.',
  ...
  recharge: {
    ...
    methodWechat: 'WeChat',
    methodUsdt: 'USDT',
    viewAllOrders: 'View orders',
    title: 'Recharge Balance',
    description: 'Add balance to your account via online payment',
    currentBalance: 'Current Balance',
    disabled: 'Recharge Unavailable',
    disabledDesc: 'Recharge is currently disabled. Please contact the administrator.',
    loadConfigFailed: 'Failed to load recharge configuration',
    formTitle: 'Recharge',
    priceInfo: 'Current rate: ¥{price}/USD',
    amountLabel: 'Amount (CNY)',
    amountPlaceholder: 'Enter amount ({min} - {max})',
    amountHint: 'Amount range: ¥{min} - ¥{max}',
    creditPreview: 'Estimated credit',
    payTypeLabel: 'Payment Method',
    payType_alipay: 'Alipay',
    payType_wxpay: 'WeChat Pay',
    submitButton: 'Recharge Now',
    submitting: 'Creating order...',
    orderCreated: 'Order created. Please scan QR code to pay.',
    createOrderFailed: 'Failed to create order',
    paymentSuccess: 'Payment successful! Balance has been credited.',
    checkingPayment: 'Checking payment result...',
    scanToPay: 'Scan to Pay',
    payAmount: 'Payment Amount',
    scanQRHintWechat: 'Scan the QR code with WeChat to complete payment',
    scanQRHintAlipay: 'Scan the QR code with Alipay to complete payment',
    openPayPage: 'Cannot scan? Click to open payment page',
    waitingPayment: 'Waiting for payment...',
    orderHistory: 'Recharge History',
    noOrders: 'No recharge history yet',
  ...
  usdt: {
    title: 'USDT Recharge',
    description: 'On-chain USDT (TRC20) recharge',
    formTitle: 'USDT Recharge',
    estimatedPay: 'Estimated payment',
    rateHint: 'Reference rate 1 USDT ≈ ¥{rate} (the locked amount at order time prevails)',
    scanToPay: 'Scan to pay USDT',
    selectChain: 'Select network',
    amountLabel: 'Amount (USDT)',
    amountPlaceholder: 'Enter USDT amount',
    amountHint: 'Range {min} - {max} USDT',
    amountHintNoMax: 'Min {min} USDT, no upper limit',
    networkWarning: '{chain} network ONLY. Do not send from another network or funds will be lost.',
    payExactAmountNotice: 'Transfer this EXACT amount',
    amountMustMatch: 'The amount must match exactly (to 6 decimals), otherwise it cannot be auto-credited',
    copy: 'Copy',
    copied: 'Copied',
  ...
  admin: {
    ...
    dashboard: {
      ...
      accountCost: 'Cost',
      recentUsage: 'Recent Usage',
      financeTrendTitle: 'Recharge & Consumption Trend (USD)',
      platformBalance: 'Platform Total Balance',
      platformBalanceHint: 'Sum of all user balances',
      channelBalance: 'Total Channel Balance',
      channelBalanceHint: 'Sum of cached balances across all channels',
    ...
    groups: {
      ...
      form: {
        ...
        translateAll: 'Auto-translate',
        translating: 'Translating…',
        translateAllHint: 'Use the configured LLM to translate name and description into all languages (overrides existing translations).',
        translateNoSource: 'Fill in name or description first.',
        translateSuccess: 'Translation complete',
        translateEmpty: 'Translation returned but target-language fields were empty — check the model output.',
        platform: 'Platform',
        rateMultiplier: 'Rate Multiplier',
        status: 'Status',
      ...
      smartRouter: {
        enable: 'Enable Smart Router (virtual failover group)',
        enableHint: 'When enabled, this group acts as a virtual router, forwarding requests to member groups in order with automatic failover.',
        enabledBadge: 'Smart Router enabled',
        editHint: 'For smart router groups only name, description, status, and member list are editable. Rate, limits, and routing are managed by members.',
        members: 'Member groups (ordered)',
        membersHint: 'Ordered priority list; the first healthy member becomes active',
        addMember: 'Add member...',
        openDetail: 'Open detail page →',
        detailTitle: 'Smart Router Detail',
        detailDescription: 'View member health, usage, event timeline, and manage manual pin',
        active: 'Active',
        ...
        pinActive: 'Manual pin active',
        pinExpiresAt: 'expires at',
        clearPin: 'Clear pin',
        ...
        pinDialog: {
          title: 'Pin to member',
          description: 'Auto-routing will be short-circuited; traffic will be fixed to:',
          confirm: 'Confirm pin',
          ttl: 'Pin duration',
          ttl30m: '30 minutes',
          ttl2h: '2 hours',
          ttl8h: '8 hours',
          ttl24h: '24 hours',
          ttlPermanent: 'Permanent (manual release required)'
        }
      },
      modelRouting: {
        title: 'Model Routing',
    ...
    channels: {
      ...
      noBalanceUrls: 'No channels have a balance URL configured',
    ...
    accounts: {
      ...
      quotaLimitHint: 'Set 5h/daily/weekly/total spending limits (USD). Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
      ...
      quota5hLimit: '5-Hour Limit',
      quota5hLimitHint: 'Rolling 5-hour window. Automatically resets every 5 hours from first usage.',
    ...
    settings: {
      ...
      features: {
        ...
        translation: {
          title: 'Auto-Translate (Multilingual Fields)',
          description: 'Configure an OpenAI-compatible model used by the "Auto-translate" button on multilingual fields (e.g. groups) to fill other languages.',
          baseUrl: 'Base URL',
          baseUrlHint: 'Root URL of the OpenAI-compatible chat/completions endpoint (do not include /v1).',
          model: 'Model',
          modelHint: 'Pick a cheap model with reliable JSON output, e.g. gpt-4o-mini.',
          apiKey: 'API Key',
          apiKeyHint: 'Server-side only; never echoed back to the client.',
          apiKeyConfiguredHint: 'API key is configured. Leave empty to keep the current value.',
          timeout: 'Timeout (ms)',
          timeoutHint: 'Per-request timeout for translation calls.',
          save: 'Save Translation Config',
          saved: 'Translation config saved',
      ...
      recharge: {
        ...
        enabledHint: 'When enabled, users will see a recharge entry in the sidebar to top up their balance',
        minAmount: 'Min Amount (¥)',
        maxAmount: 'Max Amount (¥)',
        payTypes: 'Payment Methods',
        ...
        epayTitle: 'Payment Gateway Configuration',
        epayApiUrl: 'API URL',
        epayPid: 'Merchant ID (PID)',
        epayKey: 'Merchant Key',
        epayKeyPlaceholder: 'Enter merchant key',
        epayKeyHint: 'Key is only updated when provided. Leave empty to keep existing value.',
        keyConfigured: 'Configured',
      },
      alimpay: {
        title: 'Alipay Personal P2P (AliMPay)',
        description: 'Personal P2P Alipay collection via bill polling. Changes take effect immediately without restart.',
        enabled: 'Enable AliMPay',
        enabledHint: 'When enabled, the Alipay QR recharge entry is exposed and the background Monitor starts matching bills',
        mode: 'Collection Mode',
        modeBusinessQR: 'Business QR (match by amount offset)',
        modeTransfer: 'Transfer (match by order note)',
        modeHint: 'Business QR requires a merchant QR code; Transfer mode requires the Alipay user ID',
        appId: 'App ID',
        appIdPlaceholder: 'Alipay Open Platform app id',
        privateKey: 'App Private Key (RSA2)',
        privateKeyPlaceholder: 'Paste PKCS1/PKCS8 RSA private key',
        alipayPublicKey: 'Alipay Public Key',
        alipayPublicKeyPlaceholder: 'Paste the public key provided by Alipay',
        keyConfigured: 'Configured',
        keyKeepPlaceholder: 'Already configured (leave empty to keep)',
        keyHint: 'Private key is stored in the settings table and used to sign API requests',
        businessQRURL: 'Business QR URL',
        businessQRURLHint: 'Full https://qr.alipay.com/... link; users scan this to pay',
        amountOffset: 'Amount Offset Step (¥)',
        amountOffsetHint: 'Orders with the same base amount are distinguished by offset, default 0.01',
        transferUserId: 'Payee Alipay UID',
        transferUserIdHint: 'Value of the "u" field in alipays:// biz_data',
        advanced: 'Advanced',
        serverURL: 'Alipay Gateway URL',
        orderTimeoutSeconds: 'Order Timeout (seconds)',
        monitorIntervalSeconds: 'Poll Interval (seconds)',
        matchToleranceSeconds: 'Match Tolerance (seconds)',
        queryMinutesBack: 'Bill Query Lookback (minutes)',
        saveButton: 'Save AliMPay Config',
        saveSuccess: 'AliMPay config saved and applied',
      },
      usdt: {
        title: 'USDT Self-hosted Collection (Multi-chain)',
        description: 'On-chain USDT collection by polling, supports TRC20 / BEP20 / TON. Changes take effect immediately, no restart needed.',
        ...
        minAmount: 'Min Recharge (USDT)',
        maxAmount: 'Max Recharge (USDT)',
        maxAmountHint: '0 = no upper limit',
        receivingAddress: 'TRC20 Receiving Address',
        receivingAddressHint: 'A TRON address starting with T; all orders are collected here (use a watch-only wallet, never store private keys on the server)',
        tronApiKey: 'TronGrid API Key',
        tronApiKeyPlaceholder: 'API key from trongrid.io',
        tronApiKeyHint: 'Increases TronGrid rate limits; strongly recommended',
        keyConfigured: 'Configured',
        keyKeepPlaceholder: 'Configured (leave blank to keep current)',
        rateSection: 'Exchange Rate',
        rateAutoFetch: 'Auto-fetch rate',
        rateAutoFetchHint: 'Fetches USDT/CNY from CoinGecko, falls back to the manual rate on failure',
        manualRate: 'Manual Rate (1 USDT = ? CNY)',
        manualRateHint: 'Used when auto-fetch is off, and as fallback when it fails',
        rateMarkup: 'Markup (0~1)',
        rateMarkupHint: 'Conversion rate = rate×(1-markup), making users pay slightly more USDT; 0 = no markup',
        advanced: 'Advanced',
        tronApiBaseUrl: 'TronGrid Base URL',
        amountOffset: 'Unique Amount Step (USDT)',
        amountTolerance: 'Amount Tolerance (USDT)',
        amountToleranceHint: 'Received within ±tolerance counts as paid (credited by ordered amount); the amount step auto-grows to >2×tolerance to avoid mismatches',
        confirmSeconds: 'Confirmation Wait (sec)',
        orderTimeoutSeconds: 'Order Timeout (sec)',
        monitorIntervalSeconds: 'Poll Interval (sec)',
        queryMinutesBack: 'Chain Lookback (min)',
        saveButton: 'Save USDT Config',
        saveSuccess: 'USDT config saved and applied',
      },
      customMenu: {
    ...
    usdtOrders: {
      title: 'USDT Orders',
      description: 'View and manage USDT (TRC20) recharge orders',
