  ...
  admin: {
    ...
    settings: {
      ...
      recharge: {
        ...
        epayPublicKey: 'Platform Public Key',
        epayPrivateKey: 'Merchant Private Key',
        epayPublicKeyPlaceholder: 'Paste RSA public key (PEM or raw Base64)',
        epayPrivateKeyPlaceholder: 'Paste RSA private key (PEM or raw Base64)',
        epayKeyHint: 'Keys are only updated when provided. Leave empty to keep existing value.',
