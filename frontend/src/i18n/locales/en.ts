export default {
  ...
  usdt: {
    ...
    networkWarning: 'TRON (TRC20) network ONLY. Do not send from another network or funds will be lost.',
  ...
  admin: {
    ...
    settings: {
      ...
      usdt: {
        title: 'USDT (TRC20) Self-hosted Collection',
        description: 'On-chain USDT collection by polling TronGrid. Changes take effect immediately, no restart needed.',
        enabled: 'Enable USDT',
