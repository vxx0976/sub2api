export default {
  ...
  reseller: {
    ...
    serviceTokens: {
      title: 'API Tokens',
      description: 'Let your backend automate key management (reset quota, enable/disable, create keys) without logging into the dashboard.',
      create: 'Issue New Token',
      name: 'Label',
      namePlaceholder: 'e.g. billing-backend',
      expiresInDays: 'Expires in (days)',
      expiresInDaysHint: 'Leave empty or 0 for no expiry',
      neverExpires: 'Never expires',
      issue: 'Issue',
      createdTitle: 'Token Issued',
      createdWarning: 'Copy it now — the plaintext is shown only once and cannot be retrieved again after closing.',
      copy: 'Copy',
      copied: 'Copied',
      never: 'Never used',
      statusActive: 'Active',
      ...
      revoke: 'Revoke',
      revokeConfirm: 'Revoking immediately breaks any backend using this token. Continue?',
      revokeSuccess: 'Token revoked',
      empty: 'No API tokens yet',
      usageTitle: 'How to use',
      usageHint: 'Send the X-Reseller-Token header to call the endpoints below (scoped to your own keys only):',
      usageResetComment: 'On client payment: reset quota (auto-reactivates keys disabled by quota exhaustion)',
      usageEnableComment: 'Enable a key when needed',
      columns: {
        name: 'Label',
        prefix: 'Prefix',
        status: 'Status',
    ...
    settings: {
      ...
      accessHint: 'Control registration and login on this merchant site',
      disableRegistration: 'Disable Registration',
      disableRegistrationHint: 'When enabled, new user registration on this site will be rejected',
      disableLogin: 'Disable Login',
      disableLoginHint: 'When enabled, sub-users cannot log in to this site (merchant/admin not affected)',
