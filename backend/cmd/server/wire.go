...
func provideCleanup(
	...
	channelBalanceRefresh *service.ChannelBalanceRefreshService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"ChannelBalanceRefreshService", func() error {
				if channelBalanceRefresh != nil {
					channelBalanceRefresh.Stop()
				}
				return nil
			}},
