...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	resellerHandlers := handler.ProvideResellerHandlers(resellerDashboardHandler, domainHandler, resellerSettingHandler, keyHandler, resellerRedeemHandler, resellerAnnouncementHandler, resellerUserHandler)
