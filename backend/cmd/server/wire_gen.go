...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	redeemCodeRepository := repository.NewRedeemCodeRepository(client, db)
	...
	referralService := service.NewReferralService(referralRepository, userRepository)
	...
	authHandler := handler.NewAuthHandler(configConfig, authService, userService, settingService, promoService, referralService, redeemService, totpService, userAttributeService)
	...
	channelService := service.NewChannelService(channelRepository, groupRepository, apiKeyAuthCacheInvalidator, pricingService, accountRepository, channelCachePubSub)
	...
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, resellerSettingRepository, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, compositeRouteResolver, balanceNotifyService, serviceUserPlatformQuotaRepository)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, serviceUserPlatformQuotaRepository, resellerSettingRepository)
	...
	adminUserHandler := admin.NewUserHandler(adminService, concurrencyService, resellerDomainRepository, serviceUserPlatformQuotaRepository, billingCache, totpService, userService, settingService)
	...
	groupHandler := admin.NewGroupHandlerWithConfig(adminService, dashboardService, groupCapacityService, groupHealthCheckService, configConfig)
	...
	adminAnnouncementHandler := admin.NewAnnouncementHandler(announcementService, userService)
	...
	referralHandler := admin.NewReferralHandler(referralService)
	...
	translationService := service.NewTranslationService(settingRepository)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, referralHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, merchantHandler, adminWithdrawalHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, translationHandler, chatHandler, complianceHandler, modelPricingHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService, openCodeGoUsageService)
	resellerService := service.NewResellerService(userRepository, resellerDomainRepository, groupRepository, resellerSettingRepository, apiKeyRepository, apiKeyService, redeemCodeRepository, announcementRepository, client)
	resellerDashboardHandler := reseller.NewDashboardHandler(resellerService)
	domainHandler := reseller.NewDomainHandler(resellerService, settingService)
	resellerSettingHandler := reseller.NewSettingHandler(resellerService)
	keyHandler := reseller.NewKeyHandler(resellerService)
	resellerRedeemHandler := reseller.NewRedeemHandler(resellerService)
	resellerAnnouncementHandler := reseller.NewAnnouncementHandler(resellerService)
	resellerUserHandler := reseller.NewUserHandler(resellerService)
	commissionHandler := reseller.NewCommissionHandler(commissionService)
	withdrawalHandler := reseller.NewWithdrawalHandler(commissionService)
	resellerAPITokenRepository := repository.NewResellerAPITokenRepository(client)
	resellerAPITokenService := service.NewResellerAPITokenService(resellerAPITokenRepository)
	serviceTokenHandler := reseller.NewServiceTokenHandler(resellerAPITokenService)
	resellerHandlers := handler.ProvideResellerHandlers(resellerDashboardHandler, domainHandler, resellerSettingHandler, keyHandler, resellerRedeemHandler, resellerAnnouncementHandler, resellerUserHandler, commissionHandler, withdrawalHandler, serviceTokenHandler)
	usageRecordWorkerPool := service.NewUsageRecordWorkerPool(configConfig)
	userMsgQueueCache := repository.NewUserMsgQueueCache(redisClient)
	userMessageQueueService := service.ProvideUserMessageQueueService(userMsgQueueCache, rpmCache, configConfig)
	groupStatusCache := repository.NewGroupStatusCache(redisClient)
	...
	rechargeService := service.NewRechargeService(rechargeOrderRepository, settingRepository, adminService, leaderLockCache, db)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, resellerHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, handlerReferralHandler, totpHandler, passkeyHandler, keyQueryHandler, rechargeHandler, orderHandler, usdtHandler, mergedOrderHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, handlerChatHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
	...
	resellerServiceTokenAuthMiddleware := middleware.NewResellerServiceTokenAuthMiddleware(resellerAPITokenService, userService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, resellerAuthMiddleware, resellerServiceTokenAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, resellerDomainRepository, resellerSettingRepository, compositeRouteResolver, redisClient, db, groupService, groupStatusCache)
	...
	accountExpiryService := service.ProvideAccountExpiryService(accountRepository, leaderLockCache, db)
	...
	proxyHealthService := service.ProvideProxyHealthService(proxyRepository, proxyExitInfoProber, leaderLockCache, db)
	subscriptionExpiryService := service.ProvideSubscriptionExpiryService(userSubscriptionRepository, settingRepository, notificationEmailService, leaderLockCache, db)
	channelBalanceRefreshService := service.ProvideChannelBalanceRefreshService(channelService, settingService, leaderLockCache, db)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, cnProviderBalanceCheckService, openAICodexVersionSyncService, claudeCodeVersionSyncService, proxyExpiryService, proxyHealthService, subscriptionExpiryService, channelBalanceRefreshService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, rechargeService, orderService, alipayMonitor, usdtOrderService, usdtMonitor, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, groupHealthCheckService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, openCodeGoUsageService, auditLogService, openAIQuotaAutoResetService, promptService, pluginManager)
