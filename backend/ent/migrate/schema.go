...
var (
	...
	// FailoverGroupEventsColumns holds the columns for the "failover_group_events" table.
	FailoverGroupEventsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "virtual_group_id", Type: field.TypeInt64},
		{Name: "from_member_id", Type: field.TypeInt64, Nullable: true},
		{Name: "to_member_id", Type: field.TypeInt64, Nullable: true},
		{Name: "reason", Type: field.TypeString, Size: 40},
		{Name: "triggered_by", Type: field.TypeInt64, Nullable: true},
	...
	// FailoverGroupEventsTable holds the schema information for the "failover_group_events" table.
	FailoverGroupEventsTable = &schema.Table{
		Name:       "failover_group_events",
		Columns:    FailoverGroupEventsColumns,
		PrimaryKey: []*schema.Column{FailoverGroupEventsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "failovergroupevent_virtual_group_id_occurred_at",
				Unique:  false,
				Columns: []*schema.Column{FailoverGroupEventsColumns[1], FailoverGroupEventsColumns[7]},
			},
			{
				Name:    "failovergroupevent_occurred_at",
				Unique:  false,
				Columns: []*schema.Column{FailoverGroupEventsColumns[7]},
			},
		},
	}
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "description", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "name_i18n", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "description_i18n", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		...
		{Name: "is_failover_group", Type: field.TypeBool, Default: false},
		{Name: "failover_member_ids", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "failover_active_member_id", Type: field.TypeInt64, Nullable: true},
		{Name: "failover_active_version", Type: field.TypeInt64, Default: 0},
	...
	ReferralRewardsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "referrer_reward", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,2)"}},
		{Name: "invitee_reward", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,2)"}},
		{Name: "skip_referrer_reason", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "trigger_order_id", Type: field.TypeInt64, Unique: true},
	...
	ReferralRewardsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "referral_rewards_orders_referral_reward",
				Columns:    []*schema.Column{ReferralRewardsColumns[6]},
			...
			{
				Symbol:     "referral_rewards_users_referral_reward_received",
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "referralreward_trigger_order_id",
				Unique:  false,
				Columns: []*schema.Column{ReferralRewardsColumns[6]},
			},
			{
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "platform_cost_snapshot", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[32], UsageLogsColumns[43]},
			},
			{
	...
	UsdtOrdersColumns = []*schema.Column{
		...
		{Name: "receiving_address", Type: field.TypeString, Size: 128},
		...
		{Name: "from_address", Type: field.TypeString, Nullable: true, Size: 128},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "referral_code", Type: field.TypeString, Unique: true, Nullable: true, Size: 8},
		{Name: "referred_by", Type: field.TypeInt64, Nullable: true},
		{Name: "referral_rewarded", Type: field.TypeBool, Default: false},
...
func init() {
	...
	FailoverGroupEventsTable.Annotation = &entsql.Annotation{
	...
	ReferralRewardsTable.ForeignKeys[0].RefTable = OrdersTable
