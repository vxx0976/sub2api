...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "proxy_failure_origin_id", Type: field.TypeInt64, Nullable: true},
	...
	ProxiesColumns = []*schema.Column{
		...
		{Name: "failure_fallback_mode", Type: field.TypeString, Size: 20, Default: "none"},
		{Name: "failure_backup_proxy_id", Type: field.TypeInt64, Nullable: true},
		{Name: "health_status", Type: field.TypeString, Size: 20, Default: "healthy"},
		{Name: "health_changed_at", Type: field.TypeTime, Nullable: true},
		{Name: "health_last_error", Type: field.TypeString, Nullable: true, Size: 500},
		{Name: "health_fail_streak", Type: field.TypeInt, Default: 0},
		{Name: "health_ok_streak", Type: field.TypeInt, Default: 0},
	...
	ProxiesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ProxiesColumns[21]},
				RefColumns: []*schema.Column{ProxiesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			{
				Name:    "proxy_failure_backup_proxy_id",
				Unique:  false,
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[34], UsageLogsColumns[45]},
			},
			{
