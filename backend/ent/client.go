...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.AuthIdentity, c.AuthIdentityChannel, c.Channel, c.ErrorPassthroughRule,
		c.FailoverGroupEvent, c.Group, c.IdempotencyRecord, c.IdentityAdoptionDecision,
		c.Order, c.PaymentAuditLog, c.PaymentOrder, c.PaymentProviderInstance,
...
type (
	hooks struct {
		...
		AuthIdentityChannel, Channel, ErrorPassthroughRule, FailoverGroupEvent, Group,
