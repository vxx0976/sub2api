...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ChannelMonitorRequestTemplate, c.ChatConversation, c.ChatMessage,
...
type (
	hooks struct {
		...
		ChannelMonitorHistory, ChannelMonitorRequestTemplate, ChatConversation,
		ChatMessage, ErrorPassthroughRule, FailoverGroupEvent, Group,
