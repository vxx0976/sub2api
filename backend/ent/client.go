...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.AuthIdentity, c.AuthIdentityChannel, c.Channel, c.ChannelMonitor,
		c.ChannelMonitorDailyRollup, c.ChannelMonitorHistory,
		c.ChannelMonitorRequestTemplate, c.ErrorPassthroughRule, c.FailoverGroupEvent,
		c.Group, c.IdempotencyRecord, c.IdentityAdoptionDecision, c.Order,
		c.PaymentAuditLog, c.PaymentOrder, c.PaymentProviderInstance,
		c.PendingAuthSession, c.PromoCode, c.PromoCodeUsage, c.Proxy, c.RechargeOrder,
		c.RedeemCode, c.ReferralReward, c.ResellerDomain, c.ResellerSetting,
		c.ResellerWithdrawal, c.SecuritySecret, c.Setting, c.SubscriptionPlan,
...
// QueryOrders queries the orders edge of a Group.
func (c *GroupClient) QueryOrders(_m *Group) *OrderQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, group.OrdersTable, group.OrdersColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *OrderClient) QueryGroup(_m *Order) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryInvitee queries the invitee edge of a ReferralReward.
func (c *ReferralRewardClient) QueryInvitee(_m *ReferralReward) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryTriggerOrder queries the trigger_order edge of a ReferralReward.
func (c *ReferralRewardClient) QueryTriggerOrder(_m *ReferralReward) *OrderQuery {
	query := (&OrderClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryReferralRewardReceived queries the referral_reward_received edge of a User.
func (c *UserClient) QueryReferralRewardReceived(_m *User) *ReferralRewardQuery {
	query := (&ReferralRewardClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
			sqlgraph.To(referralreward.Table, referralreward.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.ReferralRewardReceivedTable, user.ReferralRewardReceivedColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
type (
	hooks struct {
		...
		AuthIdentityChannel, Channel, ChannelMonitor, ChannelMonitorDailyRollup,
		ChannelMonitorHistory, ChannelMonitorRequestTemplate, ErrorPassthroughRule,
		FailoverGroupEvent, Group, IdempotencyRecord, IdentityAdoptionDecision, Order,
		PaymentAuditLog, PaymentOrder, PaymentProviderInstance, PendingAuthSession,
		PromoCode, PromoCodeUsage, Proxy, RechargeOrder, RedeemCode, ReferralReward,
