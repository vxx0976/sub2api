...
func init() {
	...
	failovergroupeventFields := schema.FailoverGroupEvent{}.Fields()
	_ = failovergroupeventFields
	// failovergroupeventDescReason is the schema descriptor for reason field.
	failovergroupeventDescReason := failovergroupeventFields[3].Descriptor()
	// failovergroupevent.ReasonValidator is a validator for the "reason" field. It is called by the builders before save.
	failovergroupevent.ReasonValidator = failovergroupeventDescReason.Validators[0].(func(string) error)
	// failovergroupeventDescOccurredAt is the schema descriptor for occurred_at field.
	failovergroupeventDescOccurredAt := failovergroupeventFields[6].Descriptor()
	// failovergroupevent.DefaultOccurredAt holds the default value on creation for the occurred_at field.
	failovergroupevent.DefaultOccurredAt = failovergroupeventDescOccurredAt.Default.(func() time.Time)
	...
	groupDescIsPurchasable := groupFields[31].Descriptor()
	...
	groupDescIsRecommended := groupFields[33].Descriptor()
	...
	groupDescResellerTemplate := groupFields[37].Descriptor()
	...
	groupDescHealthCheckIntervalMin := groupFields[42].Descriptor()
	...
	groupDescHealthCheckTestModel := groupFields[43].Descriptor()
	...
	groupDescHealthStatus := groupFields[44].Descriptor()
	...
	groupDescHealthyAccounts := groupFields[45].Descriptor()
	...
	groupDescTotalCheckedAccounts := groupFields[46].Descriptor()
	...
	groupDescIsFailoverGroup := groupFields[48].Descriptor()
	...
	groupDescFailoverActiveVersion := groupFields[51].Descriptor()
	...
	usagelogDescCountryCode := usagelogFields[36].Descriptor()
	...
	userDescRegisterDomain := userFields[17].Descriptor()
	...
	userDescTokenVersion := userFields[19].Descriptor()
	...
	userDescRoleVersion := userFields[20].Descriptor()
	...
	userDescBalanceNotifyEnabled := userFields[21].Descriptor()
	...
	userDescBalanceNotifyThresholdType := userFields[22].Descriptor()
	...
	userDescBalanceNotifyExtraEmails := userFields[24].Descriptor()
	...
	userDescTotalRecharged := userFields[25].Descriptor()
