...
type storageConfig struct {
	...
	AuditLatestTurnOnly    bool              `json:"audit_latest_turn_only"`
...
func PublicFromStorage(cfg storageConfig, riskControlEnabled bool, invalidTokenEndpointIDs []string) PublicConfig {
	...
	return PublicConfig{
		...
		AuditLatestTurnOnly: cfg.AuditLatestTurnOnly, StorePassEvents: cfg.StorePassEvents,
...
func ActiveFromStorage(cfg storageConfig, riskControlEnabled bool, encryptor SecretEncryptor) (ActiveConfig, error) {
	active := ActiveConfig{
		...
		BlockingLatestTurnOnly: cfg.BlockingLatestTurnOnly, AuditLatestTurnOnly: cfg.AuditLatestTurnOnly,
...
func changeSummary(cfg storageConfig) string {
	...
	}{cfg.Enabled, cfg.BlockingEnabled, cfg.BlockingLatestTurnOnly, cfg.AuditLatestTurnOnly, cfg.StorePassEvents, len(cfg.Endpoints), len(cfg.Scanners), cfg.AllGroups, len(cfg.GroupIDs), ""}
