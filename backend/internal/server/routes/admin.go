...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/finance-trend", h.Admin.Dashboard.GetFinanceTrend)
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.POST("/test-balance", h.Admin.Channel.TestBalance)
...
func registerAdminMerchantRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	merchants := admin.Group("/merchants")
	{
		...
		merchants.POST("/backfill-snapshots", h.Admin.Merchant.BackfillSnapshots)
