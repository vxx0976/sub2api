...
func NewAuthHandler(cfg *config.Config, authService *service.AuthService, userService *service.UserService, settingService *service.SettingService, promoService *service.PromoService, referralService *service.ReferralService, totpService *service.TotpService) *AuthHandler {
	return &AuthHandler{
		cfg:             cfg,
