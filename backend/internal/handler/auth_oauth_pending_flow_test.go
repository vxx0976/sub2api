...
func (r *oauthPendingFlowRedeemCodeRepo) ListByOwnerID(context.Context, int64, pagination.PaginationParams) ([]service.RedeemCode, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
...
func (r *oauthPendingFlowRedeemCodeRepo) ListManualBalanceAdjustments(context.Context, *int64, int) ([]service.RedeemCode, int64, error) {
...
func (r *oauthPendingFlowUserRepo) CountByParentIDToday(ctx context.Context, parentID int64) (int64, error) {
	return 0, nil
}

func (r *oauthPendingFlowUserRepo) DeductBalanceIfSufficient(ctx context.Context, id int64, amount float64) error {
	return nil
}

func (r *oauthPendingFlowUserRepo) ListIDsByParentID(ctx context.Context, parentID int64) ([]int64, error) {
	return nil, nil
}
...
func (r *oauthPendingFlowUserRepo) SumTotalBalance(context.Context) (float64, error) {
	return 0, nil
}
