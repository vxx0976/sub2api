...
func TestPublicSettingsInjectionPayload_SchemaDoesNotDrift(t *testing.T) {
	...
	dtoOnlyFields := map[string]string{
		...
		// Reseller branding fields are merged into SSR JSON at request time by
		// web/embed_on.go mergeResellerBranding (keyed by reseller domain),
		// not statically injected via PublicSettingsInjectionPayload.
		"reseller_id":            "reseller branding, injected via mergeResellerBranding",
		"reseller_domain":        "reseller branding, injected via mergeResellerBranding",
		"reseller_agent_enabled": "reseller branding, injected via mergeResellerBranding",
		"brand_color":            "reseller branding, injected via mergeResellerBranding",
		"custom_css":             "reseller branding, injected via mergeResellerBranding",
		"login_redirect":         "reseller branding, injected via mergeResellerBranding",
		"purchase_enabled":       "reseller branding, injected via mergeResellerBranding",
		"purchase_url":           "reseller branding, injected via mergeResellerBranding",
		"home_template":          "reseller branding, injected via mergeResellerBranding",
		"seo_title":              "reseller branding, injected via mergeResellerBranding",
		"seo_description":        "reseller branding, injected via mergeResellerBranding",
		"seo_keywords":           "reseller branding, injected via mergeResellerBranding",
	}
