...
func (s *stubAdminService) RefundUserBalance(ctx context.Context, userID int64, amount float64, notes string) error {
	return nil
}
...
func (s *stubAdminService) ListGroups(ctx context.Context, page, pageSize int, platform, status, search string, isExclusive *bool, isPurchasable *bool, sortBy, sortOrder string) ([]service.Group, int64, error) {
...
func (s *stubAdminService) DeleteGroup(ctx context.Context, id int64, migrateToGroupID *int64) error {
	return nil
}
...
func (s *stubAdminService) ListAdminBalanceAdjustments(ctx context.Context, userID *int64, limit int) ([]service.RedeemCode, int64, error) {
	return s.redeems, int64(len(s.redeems)), nil
}
