...
func (s *stubAdminService) RefundUserBalance(ctx context.Context, userID int64, amount float64, notes string) (*service.User, error) {
	user := service.User{ID: userID, Balance: -amount, Status: service.StatusActive}
	return &user, nil
}
