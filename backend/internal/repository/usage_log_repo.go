...
const usageLogSelectColumns = "id, user_id, api_key_id, account_id, request_id, model, requested_model, upstream_model, group_id, subscription_id, input_tokens, output_tokens, cache_creation_tokens, cache_read_tokens, cache_creation_5m_tokens, cache_creation_1h_tokens, image_output_tokens, image_output_cost, input_cost, output_cost, cache_creation_cost, cache_read_cost, total_cost, actual_cost, rate_multiplier, account_rate_multiplier, billing_type, request_type, stream, openai_ws_mode, duration_ms, first_token_ms, user_agent, ip_address, country_code, image_count, image_size, image_input_size, image_output_size, image_size_source, image_size_breakdown, service_tier, reasoning_effort, inbound_endpoint, upstream_endpoint, cache_ttl_overridden, merchant_rate_snapshot, platform_cost_snapshot, channel_id, model_mapping_chain, billing_tier, billing_mode, account_stats_cost, created_at, requested_group_id"
...
var usageLogInsertArgTypes = [...]string{
	...
	"numeric",     // merchant_rate_snapshot
	"numeric",     // platform_cost_snapshot
	"bigint",      // channel_id
...
func (r *usageLogRepository) GetStatsWithFilters(ctx context.Context, filters UsageLogFilters) (*UsageStats, error) {
	...
	runSummary := func(c context.Context) error {
		return scanSingleRow(
			...
			&stats.TotalOutputTokens,
			&stats.TotalCacheTokens,
			&stats.TotalCacheReadTokens,     // 来自 dev：SELECT 含此列
			&stats.TotalCacheCreationTokens, // 来自 dev：SELECT 含此列
			&stats.TotalCost,
			&stats.TotalActualCost,
			&totalAccountCost,
			&stats.AverageDurationMs,
