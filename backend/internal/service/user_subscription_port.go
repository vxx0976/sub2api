...
type UserSubscriptionRepository interface {
	...
	ListByUserIDs(ctx context.Context, userIDs []int64, params pagination.PaginationParams) ([]UserSubscription, *pagination.PaginationResult, error)
	...
	DeductAndResetMonthlyUsage(ctx context.Context, id int64, expectedWindowStart *time.Time, currentUsage, deductAmount float64, newWindowStart time.Time) error
