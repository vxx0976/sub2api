...
type OrderRepository interface {
	...
	// ListByUserIDs retrieves orders for multiple users (used by reseller)
	ListByUserIDs(ctx context.Context, userIDs []int64, params pagination.PaginationParams) ([]Order, *pagination.PaginationResult, error)
