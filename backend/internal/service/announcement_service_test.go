...
func (*announcementRepoStub) ListActiveByOwnerID(context.Context, int64, time.Time) ([]Announcement, error) {
	return nil, nil
}

func (*announcementRepoStub) ListByOwnerID(context.Context, int64, pagination.PaginationParams) ([]Announcement, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
