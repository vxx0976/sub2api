...
func (r *subscriptionExpiryRepoStub) DeductAndResetMonthlyUsage(context.Context, int64, *time.Time, float64, float64, time.Time) error {
	return nil
}

func (r *subscriptionExpiryRepoStub) ResetAllUsageWindows(context.Context, int64, time.Time) error {
	return nil
}
...
func (r *subscriptionExpiryRepoStub) ListByUserIDs(context.Context, []int64, pagination.PaginationParams) ([]UserSubscription, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
