...
func TestAuthService_Register_EmailVerifyEnabledButServiceNotConfigured(t *testing.T) {
	...
	_, _, err := service.RegisterWithVerification(context.Background(), "user@test.com", "password", "any-code", "", "", "", nil, "")
...
func TestAuthService_Register_EmailVerifyRequired(t *testing.T) {
	...
	_, _, err := service.RegisterWithVerification(context.Background(), "user@test.com", "password", "", "", "", "", nil, "")
...
func TestAuthService_Register_EmailVerifyInvalid(t *testing.T) {
	...
	_, _, err := service.RegisterWithVerification(context.Background(), "user@test.com", "password", "wrong", "", "", "", nil, "")
...
func TestAuthService_SendVerifyCode_NonWhitelistDomainRejectedWhenQuotaDisabled(t *testing.T) {
	...
	err := svc.SendVerifyCode(context.Background(), "user@custom.example", EmailOptions{})
	require.ErrorIs(t, err, ErrEmailSuffixNotAllowed)
}
...
func TestAuthService_SendVerifyCodeAsync_NonWhitelistDomainRejectedWhenQuotaDisabled(t *testing.T) {
	...
	_, err := svc.SendVerifyCodeAsync(context.Background(), "user@custom.example", EmailOptions{})
	require.ErrorIs(t, err, ErrEmailSuffixNotAllowed)
}
