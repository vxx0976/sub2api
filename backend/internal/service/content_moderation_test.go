...
func (r *contentModerationTestUserRepo) SumTotalBalance(ctx context.Context) (float64, error) {
	return 0, nil
}
...
func (r *contentModerationTestUserRepo) DeductBalanceIfSufficient(ctx context.Context, id int64, amount float64) error {
	panic("unexpected DeductBalanceIfSufficient call")
}

func (r *contentModerationTestUserRepo) ListIDsByParentID(ctx context.Context, parentID int64) ([]int64, error) {
...
func (r *contentModerationTestUserRepo) ListResellerUsers(ctx context.Context, page, pageSize int, search string) ([]*MerchantInfo, int, error) {
