...
func (r *redeemRejectRepo) DeleteIfUnused(ctx context.Context, id int64) error {
	panic("unexpected DeleteIfUnused call")
}

func (r *redeemRejectRepo) ListByOwnerID(ctx context.Context, ownerID int64, params pagination.PaginationParams) ([]RedeemCode, *pagination.PaginationResult, error) {
	panic("unexpected ListByOwnerID call")
}

func (r *redeemRejectRepo) ListManualBalanceAdjustments(ctx context.Context, userID *int64, limit int) ([]RedeemCode, int64, error) {
	panic("unexpected ListManualBalanceAdjustments call")
}

func (r *redeemRejectRepo) SumManualAdminBalanceByDay(ctx context.Context, startTime, endTime time.Time, tzName string) (map[string]float64, error) {
	panic("unexpected SumManualAdminBalanceByDay call")
}

func (r *redeemRejectRepo) SumPositiveValueByDayForTypes(ctx context.Context, startTime, endTime time.Time, tzName string, types []string) (map[string]float64, error) {
	panic("unexpected SumPositiveValueByDayForTypes call")
}
