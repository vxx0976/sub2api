...
type Group struct {
	...
	ProfitMinMargin      float64 `json:"profit_min_margin,omitempty"`    // 最低毛利率，小数存储（0.30=30%）
	ProfitSafetyBuffer   float64 `json:"profit_safety_buffer,omitempty"` // 安全缓冲，小数，与 margin 相加后从 D 中扣除
