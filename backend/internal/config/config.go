...
// Note: 'unsafe-inline' is added to script-src for Cloudflare Turnstile compatibility (used as fallback when nonce is not supported).
// stripe.com / airwallex domains added for payment integrations.
// *.alicdn.com (Aliyun Captcha 2.0) / turing.captcha.qcloud.com + *.captcha.gtimg.com (Tencent 天御) added for the captcha providers.
// 上游本轮补齐了腾讯天御国际站域名（tycaptcha.com / global.turing.captcha.gtimg.com 等）与 worker-src；
// fork 只在其基础上保留 'unsafe-inline'（去掉会让不支持 nonce 的环境里 Turnstile 失效）。
const DefaultCSPPolicy = "default-src 'self'; worker-src 'self' blob:; script-src 'self' __CSP_NONCE__ 'unsafe-inline' https://challenges.cloudflare.com https://*.alicdn.com https://static.cloudflareinsights.com https://turing.captcha.qcloud.com https://turing.captcha.gtimg.com https://ca.turing.captcha.qcloud.com https://global.turing.captcha.gtimg.com https://www.tycaptcha.com https://cloudcache.tencentcs.com https://*.stripe.com https://static.airwallex.com https://checkout.airwallex.com https://static-demo.airwallex.com https://checkout-demo.airwallex.com; style-src 'self' 'unsafe-inline' https://*.captcha.gtimg.com https://fonts.googleapis.com https://*.alicdn.com https://static.airwallex.com https://checkout.airwallex.com https://static-demo.airwallex.com https://checkout-demo.airwallex.com; img-src 'self' data: blob: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://turing.captcha.qcloud.com https://www.tycaptcha.com https://rce.tencentrio.com https:; frame-src https://challenges.cloudflare.com https://turing.captcha.qcloud.com https://ca.turing.captcha.qcloud.com https://www.tycaptcha.com https://*.stripe.com https://checkout.airwallex.com https://checkout-demo.airwallex.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'"
